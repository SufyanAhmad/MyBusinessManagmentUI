...
@Component({
  selector: 'app-edit-ledger-transactions',
  imports: [
    CommonModule,
    SelectModule,
    ToastModule,
  ...
  templateUrl: './edit-ledger-transactions.component.html',
  styleUrl: './edit-ledger-transactions.component.scss',
  providers: [MessageService],
})
export class EditLedgerTransactionsComponent {
