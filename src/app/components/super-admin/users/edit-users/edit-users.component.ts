...
import { BusinessCountModel, UserModel } from '../../../../models/super-admin/super-admin-model';
...
@Component({
  ...
  imports: [FormsModule,CommonModule,CheckboxModule,ReactiveFormsModule,ToastModule,DialogModule,ButtonModule],
  ...
  getBusinessCountsDetail(){
   ...
   editUserDetail(){
    this.editLoading = true;
     this.superAdminService.updateUserDetail(this.userId ,this.editUserModel.value).subscribe((dt) => {
